  ...
  return (
    <div className="min-h-screen bg-black text-white flex items-center justify-center relative overflow-hidden">
      ...
      <button
        ...
        className="absolute top-8 right-8 z-50 hidden md:flex items-center gap-2 backdrop-blur-md bg-white/10 border border-white/20 px-6 py-3 rounded-full text-white font-medium hover:bg-white/20 transition-all duration-300 shadow-lg"
      >
            ...
            {downloadReady ? (
              <>
                ...
                <button
                  ...
                  className="group inline-flex items-center space-x-3 bg-zinc-800 hover:bg-zinc-700 text-white px-8 py-4 rounded-full text-lg font-medium transition-all duration-300 hover:scale-105"
                >

    ...
    return (
      <div className="flex items-center justify-center h-full bg-gray-900/50 rounded-lg">
        <div className="text-center p-6">
          ...
          <h3 className="text-lg font-medium text-white mb-2">PDF Preview Error</h3>
          <p className="text-sm text-gray-400 mb-3">Unable to generate PDF preview</p>
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-0 sm:p-4">
      ...
      <div className="relative w-full h-full sm:h-auto sm:max-h-[95vh] sm:max-w-5xl bg-[#0a0a0a] sm:rounded-2xl border-0 sm:border border-gray-800 shadow-2xl flex flex-col overflow-hidden">
        {/* Header */}
        <div className="flex items-center justify-between p-4 sm:p-6 border-b border-gray-800 bg-[#0a0a0a]">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              {({ loading }) => (
                <>
                  <Download size={18} />
                  <span className="text-sm">{loading ? 'Preparing...' : 'Download'}</span>
                </>
              )}
            </PDFDownloadLink>

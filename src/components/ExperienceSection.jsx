...
const ExperienceSection = () => {
  ...
  // Secondary purple color from your existing app
  const secondaryColor = '#544cd7';
	...
	const handleInputChange = (index, field, value) => {
		...
		if (field === 'position' && value.length > 100) {
			return;
		}
		if (field === 'location' && value.length > 100) {
			return;
		}
		if ((field === 'startDate' || field === 'endDate') && 
			!/^(0[1-9]|1[0-2])\/(0[1-9]|[12][0-9]|3[01])\/(19|20)\d\d$|^(0[1-9]|1[0-2])\/(19|20)\d\d$|^(19|20)\d\d$|^Present$/.test(value)) {
			return;
		}
		*/

...
import { User, Mail, Phone, MapPin, Linkedin, Github, Info } from 'lucide-react';
...
const PersonalInfoSection = () => {
  ...
  const handleChange = (e) => {
    ...
    if (name.startsWith('links.linkedin') && value !== '' && !value.includes('linkedin.com')) {
      return;
    }
    if (name.startsWith('links.github') && value !== '' && !value.includes('github.com')) {
      return;
    }
    */
